...
$$k(x, x') = \exp \left( -\frac{2 \sin^2\left(\pi \frac{\|x-x'\|}{\omega}\right)}{l^2} \right)$$
...
$$k(x, x') = \sigma^2\exp \left( -\frac{2 \sin^2\left(\pi \frac{\|x-x'\|}{\omega}\right)}{l_p^2} \right) \exp \left( -\frac{\|x-x'\|^2}{2 l_v^2} \right)$$

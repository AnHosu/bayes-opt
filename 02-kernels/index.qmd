...
Discrete kernels quantify the similarity or correlation between data points with discrete features. These kernels are particularly useful in modelling non-continuous data, such as count data, rankings, or time series with irregular intervals.

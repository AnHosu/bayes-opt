...
To create such a design, we turn to quasi random numbers. Quasi random numbers are not random, they are a deterministic sequence of numbers that have some of the space filling properties that we looked to randomness to solve in the previous sections.

Sobol sequences and their application in improving optimization efficiency, specifically in the context of Bayesian optimization.

...
Gaussian processes represent a distribution over functions. That distribution has been conditioned on training data

We imagine a distribution of x* that maximise functions in that distribution
